                ...
                <form method="post" accept-charset="utf-8" action="checkout" class="form" novalidate="novalidate">
                    <div class="frame">
                        ...
                        <div class="frame__contents">
                            <table class="order-summary">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="order-summary__product-image">
                                            <div class="product-image__wrapper">
                                                <img class="product-image__picture" src="/highres-assets/product.jpg"  alt="Product image"/>
                                            </div>
                                        </td>
                                        <td>Lorem Widget</td>
                                        <td>1</td>
                            ...
                            <div class="form-field">
                                <label class="form-field__label form-field-checkbox__label">
                                    <input type="checkbox" name="rise-n-shine-beta" id="rise-n-shine-beta" class="form-field-checkbox__field">
                                    <span class="form-field-checkbox__note">With our “Rise & Shine” beta program, you get early access to new features, but they may not always work perfectly. You can change your beta preference at any time after you join.</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="frame">
                        <div class="frame__contents">
                            <div class="form-field">
                                <div class="form-field__contents">
                                    <input type="submit" name="submit" id="submit" class="entry--submit-button" value="Place Order" />
                                </div>
                            </div>
                        </div>
                    </div>
